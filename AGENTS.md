...
- **Do not hand-edit auto-generated TextMate stanzas.** 19 stanzas in `syntaxes/weidu-tp2.tmLanguage.yml` are generated from `server/data/weidu-tp2-base.yml` by `scripts/utils/src/update-tp2-highlight.ts`; 8 stanzas in `syntaxes/weidu-d.tmLanguage.yml` are generated from `server/data/weidu-d-base.yml` by `scripts/utils/src/update-d-highlight.ts`. Both are called via `generate-data.sh`. Edit the YAML data source, then regenerate. Auto-generated stanzas are marked with a `# Auto-generated` comment.
