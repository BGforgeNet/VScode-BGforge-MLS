...
- **Do not hand-edit auto-generated TextMate stanzas.** 17 stanzas in `syntaxes/weidu-tp2.tmLanguage.yml` are generated from `server/data/weidu-tp2-base.yml` by `scripts/utils/src/update-tp2-highlight.ts` (called via `generate-data.sh`). Edit the YAML data source, then regenerate. Auto-generated stanzas are marked with a `# Auto-generated from weidu-tp2-base.yml` comment.
