...
EXTEND_BOTTOM ~ARAN~ 8
    IF ~!Dead("Arledrian") !InPartyAllowDead("Kova") !InPartyAllowDead("Kiyone")~ THEN GOTO a5
END
EXTEND_BOTTOM ~ARAN~ 88
    IF ~!PartyHasItem("SW1H10")~ THEN GOTO a1
END
