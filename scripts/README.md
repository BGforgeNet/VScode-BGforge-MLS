...
- `scripts/utils/src/update-tp2-highlight.ts`
  Generates TextMate highlight patterns for 18 TP2 stanzas (actions, patches, flags, options, values, constants, callables, etc.) from `server/data/weidu-tp2-base.yml`.
