...
| Script                   | Description                                                                                                                                                                                     |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `test.sh`                | Main test suite run by `pnpm test`. Typechecks client/server/CLI, runs Oxlint, server unit tests, client tests, TD/TBAF sample tests, formatting checks, CLI tests, integration tests, and knip. |
