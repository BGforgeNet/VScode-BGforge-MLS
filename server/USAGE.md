...
Detailed setup guides for each editor:

- [Neovim](../docs/editors/neovim.md) — LSP, file types, settings
- [Helix](../docs/editors/helix.md) — LSP, file types, settings
- [Emacs](../docs/editors/emacs.md) — eglot/lsp-mode, file types, settings
