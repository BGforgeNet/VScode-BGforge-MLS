...
/* Generated from familiars_v2.td - do not edit */
...
APPEND %dialog%
    IF ~~ g_familiar_follow
        ...
        +~Global("g_FamSpeed","GLOBAL",0)~+ @203 DO ~SetGlobal("g_FamSpeed","GLOBAL",1) ApplySpellRES("G_FSPED1","%death_var%")~ + g_familiar_confirm
        +~Global("g_FamSpeed","GLOBAL",1)~+ @204 DO ~SetGlobal("g_FamSpeed","GLOBAL",0) ApplySpellRES("G_FSPED0","%death_var%")~ + g_familiar_confirm
        ++ @205 EXTERN %dialog% %state%
    END
    ...
    IF ~~ g_familiar_loot
        ...
        +~Global("g_FamPickupAmmo","GLOBAL",0)~+ @408 DO ~SetGlobal("g_FamPickupAmmo","GLOBAL",1)~ + g_familiar_confirm
        +~Global("g_FamPickupAmmo","GLOBAL",1)~+ @409 DO ~SetGlobal("g_FamPickupAmmo","GLOBAL",0)~ + g_familiar_confirm
        +~Global("g_FamPickupPotions","GLOBAL",0)~+ @410 DO ~SetGlobal("g_FamPickupPotions","GLOBAL",1)~ + g_familiar_confirm
        +~Global("g_FamPickupPotions","GLOBAL",1)~+ @411 DO ~SetGlobal("g_FamPickupPotions","GLOBAL",0)~ + g_familiar_confirm
        +~Global("g_FamPickupScrolls","GLOBAL",0)~+ @412 DO ~SetGlobal("g_FamPickupScrolls","GLOBAL",1)~ + g_familiar_confirm
        +~Global("g_FamPickupScrolls","GLOBAL",1)~+ @413 DO ~SetGlobal("g_FamPickupScrolls","GLOBAL",0)~ + g_familiar_confirm
        +~Global("g_FamPickupScalps","GLOBAL",0)~+ @414 DO ~SetGlobal("g_FamPickupScalps","GLOBAL",1)~ + g_familiar_confirm
        +~Global("g_FamPickupScalps","GLOBAL",1)~+ @415 DO ~SetGlobal("g_FamPickupScalps","GLOBAL",0)~ + g_familiar_confirm
        +~Global("g_FamPickupTrophy","GLOBAL",0)~+ @416 DO ~SetGlobal("g_FamPickupTrophy","GLOBAL",1)~ + g_familiar_confirm
        +~Global("g_FamPickupTrophy","GLOBAL",1)~+ @417 DO ~SetGlobal("g_FamPickupTrophy","GLOBAL",0)~ + g_familiar_confirm
        ++ @418 EXTERN %dialog% %state%
    END

    IF ~~ g_familiar_confirm
        SAY @419
        IF ~~ EXTERN %dialog% %state%
    END
END
